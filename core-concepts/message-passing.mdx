...
- **Python SDK**: Packaged Bayesian heads (`NimbusLDA`, `NimbusQDA`, `NimbusSoftmax`, and `NimbusSTS`) with optimized inference engines. [`Personalizer`](/python-sdk/middleware) uses those heads without requiring manual graph construction.
