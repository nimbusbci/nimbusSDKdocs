...
3. Train a conservative baseline (`Personalizer.for_features(..., head="lda")` or `NimbusLDA`).
...
- Save profiles / normalization with each subject (`Personalizer.save`, `export_profile()`, head artifacts).
