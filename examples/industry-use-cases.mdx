...
<Card title="Research Applications" icon="flask-conical">
  ...
  **Models**: NimbusLDA, NimbusQDA, `NimbusSoftmax` (Python), and `NimbusProbit` (Julia) with custom training<br/>
...
These industry applications demonstrate the real-world potential of Nimbus BCI's probabilistic models across healthcare, assistive technology, and research domains. Both Python and Julia SDKs provide production-ready Bayesian classifiers for motor imagery, P300, and SSVEP paradigms: Bayesian LDA and QDA in both SDKs, `NimbusSoftmax` and `NimbusSTS` in Python, and `NimbusProbit` in Julia.
