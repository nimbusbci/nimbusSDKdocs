...
Already have CSP / bandpower features? Use `Personalizer(encoder=None)` or the classical heads below. Full contract: [Personalizer & Middleware](/python-sdk/middleware).
