...
<Tip>
The same rules apply to **embedding rows** `Z` before `Personalizer.fit` / `partial_fit`, and to classical CSP / bandpower features before a standalone head. See [Personalizer & Middleware](/personalizer/overview).
</Tip>
