...
- **Python**: [Python Streaming Inference](/python-sdk/streaming-inference) documents `StreamingSession` and `StreamingSessionSTS`.
...
Use **streaming inference** when feature chunks arrive over time and the application needs low-latency updates before a complete trial has finished.
