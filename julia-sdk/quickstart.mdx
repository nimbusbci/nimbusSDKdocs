...
<Card title="Request API Access" icon="mail" href="mailto:hello@nimbusbci.com">
...
<CardGroup cols={2}>
  ...
  <Card title="Feature Normalization" icon="arrow-up-down" href="/inference-configuration/feature-normalization">
...
<AccordionGroup>
  ...
  <Accordion title="Can I run inference on raw EEG?" icon="audio-waveform">
...
<AccordionGroup>
  <Accordion icon="triangle-alert" title="Common Issues">
    **API Key Issues:**
  ...
  <Accordion icon="circle-question-mark" title="Getting Help">
