...
| --- | --- | --- |
| **L2 — affine-Z + head** | Supervised affine map on embeddings, then the same head | Paper 1b / NimbusBench ladder protocol — mid-tier in *evaluations*, not `Personalizer(...)` |
| **L3 — full FT** | Warm-start encoder fine-tune | Priced escape hatch outside the Personalizer API |
