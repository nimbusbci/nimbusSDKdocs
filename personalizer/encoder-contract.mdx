...
**Not a Personalizer knob (yet):**

| Level | What it is | Where it lives |
| --- | --- | --- |
| **L2 — affine-Z + head** | Supervised affine map on embeddings, then the same head | Paper 1 / NimbusBench ladder protocol — mid-tier in _evaluations_, not `Personalizer(...)` |
