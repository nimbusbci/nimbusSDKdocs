...
*Why the hatch stays priced: across classical trunks, stream Personalizer (L1) recovers most of warm-start FT (L3) and usually beats a matched linear probe — details on [Evidence](/personalizer/evidence).*
...
<CardGroup cols={2}>
  ...
  <Card title="Evidence" icon="chart-line" href="/personalizer/evidence">
    Head vs probe vs FT, severity sweep, REVE, transfer map.
  </Card>
