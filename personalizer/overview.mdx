...
*Why the hatch stays priced: across classical trunks, stream Personalizer (L1) recovers most of warm-start FT (L3) accuracy at a fraction of adapt wall — details and table on [Evidence](/personalizer/evidence).*
...
<CardGroup cols={2}>
  ...
  <Card title="Evidence" icon="chart-line" href="/personalizer/evidence">
    Trunks vs warm-start FT, severity sweep, REVE, transfer map.
  </Card>
