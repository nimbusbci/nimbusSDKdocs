...
<Note>
**Python Personalizer head:** use as `Personalizer(head="softmax")` (requires `pip install nimbus-bci[softmax]`), or standalone as `NimbusSoftmax`. See [Personalizer & Middleware](/personalizer/overview).
</Note>
