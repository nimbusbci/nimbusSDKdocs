...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/models/rxpolya"
  >
    **Bayesian softmax classifier** for non-Gaussian Python workflows with posterior uncertainty and active-learning support.
  </Card>
  <Card
    title="NimbusProbit (Julia)"
    icon="brain"
    href="/models/nimbusprobit"
  >
    **Bayesian multinomial probit classifier** for non-Gaussian Julia workflows built on RxInfer.
  </Card>
  <Card
...
**Python SDK:**
- **Core**: Python 3.11+, NumPy, SciPy, scikit-learn
- **Optional**: JAX for `NimbusSoftmax`
