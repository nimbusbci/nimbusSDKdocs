...
Nimbus expects embeddings or preprocessed features — not raw EEG. Start with [Personalizer & Middleware](/python-sdk/middleware) for the encoder contract, or [Preprocessing Requirements](/inference-configuration/preprocessing-requirements) for classical CSP / bandpower / ERP.
...
<CardGroup cols={3}>
  <Card title="Personalizer" icon="layers" href="/python-sdk/middleware" />
