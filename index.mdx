...
<Columns cols={3}>
  ...
  <Card title="Python SDK" icon="braces" href="/python-sdk/quickstart">
...
<Columns cols={2}>
  <Card title="Why Bayesian BCI Inference" icon="scale" href="/core-concepts/why-bayesian-bci">
    Compare classical LDA, SVM, and deep learning with Nimbus — including ~8–10× cheaper online head updates vs batch refit.
  </Card>
...
<Columns cols={2}>
  ...
  <Card title="Migration to 0.6" icon="arrow-right" href="/python-sdk/migration-0.6">
    Breaking changes when upgrading nimbus-bci.
  </Card>
  <Card title="Heads & Models" icon="brain" href="/model-specification">
...
<Columns cols={3}>
  <Card title="Personalizer" icon="layers" href="/personalizer/overview">
    Product wedge overview
  </Card>
  <Card title="Python Quickstart" icon="braces" href="/python-sdk/quickstart">
    First Personalizer in minutes
  </Card>
  <Card title="Julia Quickstart" icon="code" href="/julia-sdk/quickstart">
    Julia SDK first steps
  </Card>
</Columns>
