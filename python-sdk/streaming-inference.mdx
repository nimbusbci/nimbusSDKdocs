...
Prefer `BrainState` when shipping device / UI decisions. Keep `StreamingResult` for research diagnostics. See [Personalizer & Middleware](/python-sdk/middleware).
...
<CardGroup cols={2}>
  <Card title="Personalizer & Middleware" icon="layers" href="/python-sdk/middleware">
    BrainState contract and encoder personalization
  </Card>
