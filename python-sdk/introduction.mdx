...
<Note>
**New in `nimbus-bci` 0.4.1:** active-learning helpers for label-efficient calibration, including `suggest_next_trial()`, `should_query()`, and `calibration_sufficient()`. See [Active Learning](/python-sdk/active-learning).
</Note>
