...
Recovery \(= \Delta\mathrm{acc} / \Delta\mathrm{acc}_{\mathrm{full\,FT}}\). On Zhou2016 (supporting, \(n_{\mathrm{subj}}=4\)) the same cell is softer (~46% recovery at ~5.5× lower fit time).
