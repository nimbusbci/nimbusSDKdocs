...
The nimbus-bci **heads** are fully compatible with scikit-learn — pipelines, cross-validation, hyperparameter tuning, and the broader sklearn ecosystem. Use them standalone or as `Personalizer(head=...)` under the [middleware contract](/python-sdk/middleware).

<Tip>
**Product vs sklearn surface**
- Apps / devices: `Personalizer` → `BrainState` ([middleware](/python-sdk/middleware)).
