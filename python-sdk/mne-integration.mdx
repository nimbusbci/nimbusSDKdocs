...
1. **Product:** epochs → frozen encoder (`wrap` / BrainDecode) → [`Personalizer`](/personalizer/overview) → `BrainState`
...
Optional shortcuts: `wrap_eegnet`, `wrap_braindecode` — see [Personalizer & Middleware](/personalizer/overview).
