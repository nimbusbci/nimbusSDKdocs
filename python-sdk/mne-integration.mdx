...
adapter = Personalizer.for_deployment(enc, classes)
...
# 7. Scale + Personalizer on classical features
scaler = StandardScaler()
Z_train = scaler.fit_transform(X_train)
Z_test = scaler.transform(X_test)

adapter = Personalizer.for_features(
    ["left", "right", "feet", "tongue"], head="lda"
)
