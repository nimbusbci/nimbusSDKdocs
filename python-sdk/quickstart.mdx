...
<Info>
**Key concepts:** `wrap()` freezes the encoder contract, `Personalizer` owns the Bayesian head + gating, and `BrainState` is what apps consume. Full contract: [Personalizer & Middleware](/personalizer/overview).
</Info>
  </Step>
