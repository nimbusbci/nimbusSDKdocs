...
description: "Build your first nimbus-bci classifier in minutes with installation, sklearn integration, and real-time streaming inference."
...
# Cue and label the selected pool rows, then update.
...
<Tip>
Active learning expects feature rows shaped `(n_trials, n_features)`. See [Active Learning](/python-sdk/active-learning) for strategy guidance and stopping criteria.
</Tip>
  </Step>
